...
public class WxPayConfig {
     ...
     * 微信商户平台拼团支付结果通知URL
     */
    public final static String NOTIFY_URL_GROUP = "http://uxke9r.natappfree.cc/mall/wx/activity/callBack";

    /**
     * 微信商户平台免费试用支付结果通知URL
     */
    public final static String FREE_URL_GROUP="https://zjhkhl.com/mall/wx/free/callBack";
